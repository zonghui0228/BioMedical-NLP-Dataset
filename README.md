...
- [挑战榜单(Benchmark Evaluation)](#挑战榜单)
- [信息提取(Information Extraction)](#信息抽取)
- [实体识别(Named Entity Recognition)](#实体识别)
- [术语标准化(Entity Normalization)](#术语标准化)
- [关系抽取(Relationship Extraction)](#关系抽取)
- [事件抽取(Event Extraction)](#事件抽取)
- [共指消解(Coreference Resolution)](#共指消解)
- [文本分类(Text Classification)](#文本分类)
- [文本相似度 (Text Similarity)](#文本相似度)
- [文档检索(Document Retrieval)](#文档检索)
- [问答系统(Question Answering)](#问答系统)
- [知识图谱(Knowledge Graph)](#知识图谱)
- [预训练语言模型(Pre-trained Language Model)](#预训练语言模型)
...
![visitors](https://visitor-badge.laobi.icu/badge?page_id=zonghui0228.BioMedical-NLP-Dataset)
